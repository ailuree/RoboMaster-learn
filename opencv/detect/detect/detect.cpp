...
//
//    VideoCapture cap("G:\\temp\\vgd-before\\new\\detect--tradition\\detect\\test.mp4");//用opencv打开本地视频文件
 ...
 * @Version: 1.0
 * @Author: Barimu
 * @Date: 2022-10-18 21:36:51
 * @LastEditors: Barimu
 * @LastEditTime: 2023-01-02 20:02:49
 */
#include <opencv2/opencv.hpp>
#include <math.h>
 //#include "detect.h"
...
{
	Mat image = imread("G:/temp/vgd/vgd-test/pnp-test-before/test2.jpg");
